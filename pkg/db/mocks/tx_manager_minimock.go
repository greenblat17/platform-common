...
//go:generate minimock -i github.com/greenblat17/platform-common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/greenblat17/platform-common/pkg/db"
)
